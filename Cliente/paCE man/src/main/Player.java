...
public class Player extends GameObject implements EntityA {
    ...
    public void tick(){
        ...
        if(x != lastX || y != lastY){
            if(R){
                if(Physics.wallCollison(game.ed,this.getRR())){
                    x = lastX;
                };
            }
            if(L){
                if(Physics.wallCollison(game.ed,this.getLR())){
                    x = lastX;
                };
            }
            if(U){
                if(Physics.wallCollison(game.ed,this.getUR())){
                    y = lastY;
                };
            }
            if(D){
                if(Physics.wallCollison(game.ed,this.getDR())){
                    y = lastY;
                };
            }
